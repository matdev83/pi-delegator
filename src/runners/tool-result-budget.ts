...
export const TOOL_RESULT_BUDGET_ENV = {
	maxTotalChars: "PI_DELEGATOR_TOOL_RESULT_BUDGET_MAX_CHARS",
	statePath: "PI_DELEGATOR_TOOL_RESULT_BUDGET_STATE_PATH",
	forceEvictFraction: "PI_DELEGATOR_TOOL_RESULT_BUDGET_FORCE_EVICT_FRACTION",
} as const;
